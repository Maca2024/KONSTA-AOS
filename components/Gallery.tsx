    ...
    <div className="p-8 h-full overflow-y-auto relative">
        ...
        <div className="mt-24 border-t border-white/10 pt-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div className="order-1 md:order-2 relative h-[500px] grayscale hover:grayscale-0 transition-all duration-1000 group overflow-hidden">
                     ...
                     <img 
                        src="https://images.unsplash.com/photo-1518281959074-8482435e81c2?w=800&q=80" 
                        alt="Konsta Punkka in the field" 
                        className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-1000"
                     />
                     <div className="absolute bottom-6 left-6 z-20">
                         <p className="text-white font-serif italic text-xl">"Patience is the only gear you really need."</p>
                     </div>
                </div>
            </div>
        </div>
